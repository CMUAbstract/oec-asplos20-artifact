#!/bin/bash
# Usage: ./prep_fs_scenarios.sh
#  Run ./prep_fs_scenarios.sh from the same directory as the following files:
...
#   - fs-planet-tles, fs-spacex-tles, fs-spire-tles, dt, sensor, unis
...
do
  ...
  do
    ...
    cp ../../sim-common/sat/fs-$orbit.dat ../data/$orbit-$gnd_config-$gnd_count/sat/
