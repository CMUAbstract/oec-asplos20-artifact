# Usage: python3 cstp_latency.py /full/path/to/src/ /full/path/to/dst/
#
...
if len(sys.argv)==3:
  ...
  print('Usage: python3 cstp_latency.py /full/path/to/src/ /full/path/to/dst/')
  exit()

with open(dst+'cstp-latency.csv', 'w', newline='') as csvfile:
...
for subdir in subdirs:
  ...
  with open(dst+'cstp-latency.csv', 'a', newline='') as csvfile:
    csvwriter = csv.writer(csvfile, delimiter=',', quotechar='"')
