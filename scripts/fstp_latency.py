# Usage: python3 fstp_latency.py /full/path/to/src/ /full/path/to/dst/
#
...
if len(sys.argv)==3:
  ...
  print('Usage: python3 fstp_latency.py /full/path/to/src/ /full/path/to/dst/')
  exit()

with open(dst+'fstp-latency.csv', 'w', newline='') as csvfile:
...
for subdir in subdirs:
  ...
  with open(dst+'fstp-latency.csv', 'a', newline='') as csvfile:
    csvwriter = csv.writer(csvfile, delimiter=',', quotechar='"')
