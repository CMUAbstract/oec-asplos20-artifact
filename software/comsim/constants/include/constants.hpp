...
namespace comsim { namespace cnst {
  ...
  // See comsim/documentation/hoots1980models.pdf
  ...
  // See comsim/documentation/seppelin1974department.pdf
  ...
  // See comsim/documentation/wgs84.pdf
  ...
  // See comsim/documentation/wertz1999space.pdf
